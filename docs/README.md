...
| `06_modeling_report.md` | Ringkasan training dan evaluasi model. |
...
| `feature_engineering_formulas.md` | Penjelasan detail graph, referral, entropy, dan phone score. |
| `chatbot_query_data_source.md` | Mapping query chatbot ke sumber data. |

## Catatan

- Jika ingin penjelasan feature engineering yang lebih detail dan mudah dibaca, buka `feature_engineering_formulas.md`.
