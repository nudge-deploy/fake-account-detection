/*
Purpose: Proxy frontend checkout inference requests to the backend lifecycle endpoint.
Used by: Inference page in the Next.js app when simulating mobile checkout.
...
export async function POST(request: Request) {
  ...
  const response = await fetch(`${BACKEND_URL}/api/inference/lifecycle`, {
    ...
    body: JSON.stringify({ ...body, stage: 'checkout' }),
  });
