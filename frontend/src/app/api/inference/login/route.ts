/*
Purpose: Proxy frontend login inference requests to the backend lifecycle endpoint.
Used by: Inference page in the Next.js app when simulating mobile login.
...
export async function POST(request: Request) {
  ...
  const response = await fetch(`${BACKEND_URL}/api/inference/lifecycle`, {
    ...
    body: JSON.stringify({ ...body, stage: 'login' }),
  });
